...
select * from (
select r.mem_no, m.mem_name, r.review_no, r.review_time, r.review_image, nvl(r.review_like,0), r.review_text, a.art_name, a.art_theme , a.art_tag1 , a.art_tag2 ,a.art_tag3, at.ARTIST_NAME
from review_tb r
inner join art_info_tb_test a
on r.art_no=a.art_no
inner join member_tb_test m
...
where rownum<=3;
/******왜 0을 넣었는데 desc에서 0이 맨 위로 갈까ㅠㅠㅠㅠㅠ? *****/
